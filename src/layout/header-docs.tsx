            ...
            <nav class="max-w-7xl mx-auto px-4 h-14 flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href={`/cli?lang=${lang}`}
                       class="text-xs border border-gray-200 rounded-full px-3 py-1.5 text-gray-500 hover:border-green-600 hover:text-green-600 transition-colors hidden sm:flex items-center gap-1">
