...
export default function TroubleshootingPage(props?: any) {
    const lang: Lang = props?.lang || 'en'
    const html = getContent('ai-agents-management/troubleshooting', lang)
    ...
    return (
        <DocPage
            title="Troubleshooting — AI Agents Management — LifetimeSoft Docs"
            lang={lang}
            html={html}
